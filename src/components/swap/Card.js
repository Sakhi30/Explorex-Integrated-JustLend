...
import { GetHash } from '@Sakhi30/txplorer';
...
class SwapCard extends React.Component {
  ...
  openModal = async defaultKey => {
    ...
    //   this.setState({ modalVisible: true });
    // }
    GetHash('5573d02b40b7b1b693987e2694f131e3a2ae64c2809dd1f0f70033da7d9c3e4d');
  };
              ...
              <div className={'footer ' + (multyStart ? (BigNumber(cardData.staked).gt(0) ? 'green' : '') : 'gray')}>
                <a
                  ...
                  href={`${Config.sunSwap}?lang=${lang}${
                    cardData.symbol === 'TRX' ? '' : `?tokenAddress=${cardData.tokenAddress}&type=add`
                  }`}
                  target="_blank"
                >
